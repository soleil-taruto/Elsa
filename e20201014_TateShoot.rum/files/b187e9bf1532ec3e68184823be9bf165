...
namespace Charlotte.GameCommons
{
	public static class DDPrint
	{
		...
		private static void Print_Main2(string line, int x, int y)
		{
		...
		private static void Print_Main(string line, int x, int y)
		{
			...
			{
				DX.FillRectGraph(DDGround.MainScreenForPrint.GetHandle(), 0, 0, DDConsts.Screen_W, DDConsts.Screen_H, 0, 0, 0, 0);

				using (DDGround.MainScreenForPrint.Section())
				{
					Print_Main2(line, x, y);
				}
