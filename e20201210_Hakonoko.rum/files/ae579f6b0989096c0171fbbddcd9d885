...
namespace Charlotte.Games
{
	public class MapCell
	{
		...
		public static string[] Kine_e_Names = new string[]
		{
			...
			"A8:アルカノイド_初期進行方向=上",
			"A9:アルカノイド_初期進行方向=右上",
			"C1:クッキー_時計回り_初期位置=左下",
			"C2:クッキー_時計回り_初期位置=下",
			"C3:クッキー_時計回り_初期位置=右下",
			"C4:クッキー_時計回り_初期位置=左",
			"C6:クッキー_時計回り_初期位置=右",
			"C7:クッキー_時計回り_初期位置=左上",
			"C8:クッキー_時計回り_初期位置=上",
			"C9:クッキー_時計回り_初期位置=右上",
			"H1:クッキー_反時計回り_初期位置=左下",
			"H2:クッキー_反時計回り_初期位置=下",
			"H3:クッキー_反時計回り_初期位置=右下",
			"H4:クッキー_反時計回り_初期位置=左",
			"H6:クッキー_反時計回り_初期位置=右",
			"H7:クッキー_反時計回り_初期位置=左上",
			"H8:クッキー_反時計回り_初期位置=上",
			"H9:クッキー_反時計回り_初期位置=右上",
			"PL2:パタパタ_初期進行方向=左",
			"PL1:パタパタ_初期進行方向=左_低速",
			"PL3:パタパタ_初期進行方向=左_高速",
			"PR2:パタパタ_初期進行方向=右",
			"PR1:パタパタ_初期進行方向=右_低速",
			"PR3:パタパタ_初期進行方向=右_高速",
		};
