...
namespace Charlotte.Games
{
	public class TitleMenu : IDisposable
	{
		...
		public void Perform()
		{
			...
			this.SimpleMenu.BorderColor = new I3Color(0, 64, 0);
			this.SimpleMenu.WallColor = new I3Color(0, 150, 0);
			//this.SimpleMenu.WallPicture = Ground.I.Picture.P_TITLE_WALL;
			this.SimpleMenu.WallCurtain = -0.8;

			for (; ; )
			{
				selectIndex = this.SimpleMenu.Perform("直上視点 アクションゲーム テストコード / タイトルメニュー(仮)", items, selectIndex);
