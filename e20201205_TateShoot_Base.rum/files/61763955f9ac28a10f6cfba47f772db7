...
{
	public class Enemy_鍵山雛_Tama_01 : Enemy
	{
		private double Rad;
		private EnemyCommon.TAMA_COLOR_e Color;

		public Enemy_鍵山雛_Tama_01(double x, double y, double rad, EnemyCommon.TAMA_COLOR_e color)
		...
		protected override IEnumerable<bool> E_Draw()
		{
			...
			for (; ; )
			{
				...
				Game.I.AddEnemyCrash(DDCrashUtils.Circle(new D2Point(this.X, this.Y), 6.0), this);
