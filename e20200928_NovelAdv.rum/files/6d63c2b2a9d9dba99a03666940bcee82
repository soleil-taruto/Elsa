...
{
	/// <summary>
	/// <para>シナリオのコマンドで使う定数文字列</para>
	/// <para>あまり意味無い。廃止予定</para>
	/// </summary>
	public static class ScenarioWords
	{
		...
		public const string COMMAND_EffOff = "EffOff"; // Effect Off
		...
		public const string COMMAND_位置 = "位置";

		public const string COMMAND_再生 = "再生";
		public const string COMMAND_停止 = "停止";

		// 選択肢
		public const string COMMAND_選択肢 = "選択肢";
		public const string COMMAND_分岐先 = "分岐先";
		public const string COMMAND_Fire = "Fire";
		...
		// エフェクト
		public const string COMMAND_揺れ = "揺れ";
		public const string COMMAND_跳び = "跳び";
