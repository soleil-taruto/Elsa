...
namespace Charlotte.Games
{
	public class TitleMenu : IDisposable
	{
		...
		public void Perform()
		{
			...
			this.SimpleMenu.BorderColor = new I3Color(64, 96, 0);
			...
			for (; ; )
			{
				selectIndex = this.SimpleMenu.Perform("Hakonoko / タイトルメニュー(仮)", items, selectIndex);
					...
					case 0:
						{
							...
							{
								GameMaster.I.StartStageIndex = 1;
