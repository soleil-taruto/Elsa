...
namespace Charlotte.Games.Enemies
{
	...
	public static class EnemyCatalog
	{
		...
		private static EnemyInfo[] Tiles = new EnemyInfo[]
		{
			...
			new EnemyInfo("アイテム・ファイアボール", () => new Enemy_Item(X, Y, Enemy_Item.効用_e.WEAPON_FIRE_BALL)),
			new EnemyInfo("アイテム・レーザー", () => new Enemy_Item(X, Y, Enemy_Item.効用_e.WEAPON_LASER)),
			new EnemyInfo("アイテム・波動ビーム", () => new Enemy_Item(X, Y, Enemy_Item.効用_e.WEAPON_WAVE_BEAM)),
