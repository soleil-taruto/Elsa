...
namespace Charlotte.GameCommons
{
	...
	public class DDRandom
	{
		...
		public uint Next()
		{
			ulong uu1 = ((ulong)this.Next2() << 32) | (ulong)this.Next2();
			ulong uu2 = ((ulong)this.Next2() << 32) | (ulong)this.Next2();
			ulong uu3 = ((ulong)this.Next2() << 32) | (ulong)this.Next2();
			ulong uu4 = ((ulong)this.Next2() << 32) | (ulong)this.Next2();
