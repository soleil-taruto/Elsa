...
namespace Charlotte.Games.Shots
{
	public class Shot_Normal : Shot
	{
		...
		{
			D2Point speed = Common.GetXYSpeed(this.Direction, 10.0);
			...
			for (int frame = 0; ; frame++)
			{
				...
				DDDraw.DrawBegin(Ground.I.Picture2.IconSet[3, 35], this.X - DDGround.ICamera.X, this.Y - DDGround.ICamera.Y);
