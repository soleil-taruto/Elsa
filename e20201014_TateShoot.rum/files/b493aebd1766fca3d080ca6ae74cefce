...
namespace Charlotte.Games.Enemies
{
	public class Enemy_Item : Enemy
	{
		...
		public static Enemy_Item Create(double x, double y, EnemyCommon.DROP_ITEM_TYPE_e dropItemType)
		{
			// x
			// y
			// dropItemType

			return new Enemy_Item()
			{
				X = x,
				Y = y,
				Kind = Kind_e.ITEM,
		...
		public override void Killed()
		{
			switch (this.DropItemType)
			{
				...
				case EnemyCommon.DROP_ITEM_TYPE_e.CANDY:
					Game.I.Player.Power = Math.Min(Game.I.Player.Power + 1, Consts.PLAYER_POWER_MAX);
					break;
