...
namespace Charlotte.Games
{
	public class Logo : IDisposable
	{
		...
		public void Perform()
		{
			...
			// touch
			{
				DDGround.GeneralResource.WhiteBox.GetHandle();
				Ground.I.Picture.結月ゆかり01.GetHandle();
				Ground.I.Picture.ゆかりステッカーLogo.GetHandle();
				//Ground.I.Picture.ゆかりステッカーうさ01.GetHandle();
				//Ground.I.Picture.ゆかりステッカー純.GetHandle();
				//Ground.I.Picture.ゆかりステッカー穏.GetHandle();
				//Ground.I.Picture.ゆかりステッカー凛.GetHandle();

				// ----

				Ground.I.Music.Healing01.Touch();
				Ground.I.SE.Explosion03.Touch();
			}

			Ground.I.Music.Piano_Milkeyway.Play(); // タイトルメニューの曲を再生
