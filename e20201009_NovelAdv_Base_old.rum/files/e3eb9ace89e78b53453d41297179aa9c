...
namespace Charlotte.GameCommons
{
	public static class DDGround
	{
		...
		public static DDSubScreen MainScreenForPrint;
		...
		// UseVirtualSubScreenSize:
		// 設定を変更するには -> DDUtils.ChangeUseVirtualSubScreenMode(mode);

		public static bool UseVirtualSubScreenSize = true; // アプリ固有の設定？？？
		//public static bool UseVirtualSubScreenSize = false;
