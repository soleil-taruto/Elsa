...
namespace Charlotte.Games.Enemies
{
	...
	public static class EnemyCatalog
	{
		...
		private static EnemyInfo[] Tiles = new EnemyInfo[]
		{
			...
			new EnemyInfo("アイテム_0001", () => new Enemy_Item(X, Y, Enemy_Item.効用_e.TEST_0001)),
			new EnemyInfo("アイテム_0002", () => new Enemy_Item(X, Y, Enemy_Item.効用_e.TEST_0002)),
			new EnemyInfo("アイテム_0003", () => new Enemy_Item(X, Y, Enemy_Item.効用_e.TEST_0003)),
