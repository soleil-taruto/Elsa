...
namespace Charlotte
{
	public class ResourcePicture
	{
		...
		public DDPicture Copyright = DDPictureLoaders.Standard(@"e20201023_YokoActTM\Logo\Copyright.png");

		public DDPicture Player = DDPictureLoaders.BgTrans(@"e20201023_YokoActTM\pata2-magic\free_pochitto.png"); // プレイヤー画像 大元
