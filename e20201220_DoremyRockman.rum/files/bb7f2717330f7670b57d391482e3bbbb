...
namespace Charlotte.Games.Enemies
{
	public class Enemy_Helmet : Enemy
	{
		...
		protected override IEnumerable<bool> E_Draw()
		{
			...
			{
				while (DDUtils.IsOutOfCamera(new D2Point(this.X, this.Y))) // 画面外に居るときは休止する。
					yield return true;
				...
				// 暫定_描画
				{
					...
					DDDraw.DrawBegin(DDGround.GeneralResource.WhiteCircle, this.X - DDGround.ICamera.X, this.Y - DDGround.ICamera.Y);
