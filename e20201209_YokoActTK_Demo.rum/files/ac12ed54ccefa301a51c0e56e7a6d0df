...
namespace Charlotte.Games.Attacks
{
	public static class AttackCommon
	{
		...
		{
			bool touchSide_L = Game.I.Map.GetCell(Common.ToTablePoint(Game.I.Player.X - Consts.PLAYER_側面判定Pt_X, Game.I.Player.Y)).Tile.IsWall();
			bool touchSide_R = Game.I.Map.GetCell(Common.ToTablePoint(Game.I.Player.X + Consts.PLAYER_側面判定Pt_X, Game.I.Player.Y)).Tile.IsWall();
