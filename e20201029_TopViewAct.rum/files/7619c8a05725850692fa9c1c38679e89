...
namespace Charlotte.Games
{
	public class Game : IDisposable
	{
		...
		public void Perform()
		{
			...
			this.Player.FaceDirection = this.Status.FaceDirection;
			this.Player.選択武器 = this.Status.選択武器;
			...
			// ステータス反映
			{
				...
				this.Status.FaceDirection = this.Player.FaceDirection;
				this.Status.選択武器 = this.Player.選択武器;
			}
		}
