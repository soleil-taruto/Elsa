...
namespace Charlotte.Games
{
	...
	public class Player
	{
		...
		public PlayerTracer Tracer = new PlayerTracer();
		...
		public void Draw()
		{
			...
			if (1 <= this.DamageFrame) // 被弾モーション
			{
				...
				switch (Game.I.Player.Chara)
				{
					...
					case Chara_e.SAYAKA:
						picture = Ground.I.Picture2.さやか被弾[(this.DamageFrame * Ground.I.Picture2.さやか被弾.Length) / (Consts.PLAYER_DAMAGE_FRAME_MAX + 3)];
						xa = -20;
						break;
